...
import { IconDiscord, IconInstagram } from "@/components/icons";
import { site } from "@/content/site";

export const metadata = createPageMetadata({
  path: "/contact",
  title: "Contact Us",
  description: "Have a question about SLHS TSA? Reach us by email, Discord, or Instagram and we'll get back to you.",
});

export default function ContactPage() {
  const { email, socials, links } = site;
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 pt-10">
      ...
      <SchoolMap directionsHref={links.mapsDirections} />
    </div>
  );
}
