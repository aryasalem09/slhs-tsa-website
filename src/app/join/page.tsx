...
export const metadata = createPageMetadata({
  path: "/join",
  title: "How to Join",
  description: "Want in? Here's how to join SLHS TSA: fill out the form, pay your dues on Katy ISD Pay N' Go, and hop on Remind and Discord.",
});
...
export default function JoinPage() {
  ...
  const payNGo = site.links.payNGo;
  const remind = site.socials.remind;
  const discord = site.socials.discord;
    ...
    <div className="mx-auto max-w-3xl px-4 pt-10">
      <div className="text-center">
        ...
        <p className="mx-auto mt-5 max-w-lg font-hand text-2xl font-semibold leading-snug text-muted-ink">
          sign-ups for 26-27 are open! fill out the form below to get started.
        </p>
      </div>
