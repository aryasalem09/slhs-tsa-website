...
import { achievements, competing, officers, seasonHighlights } from "@/content/site";
import { officerAnchorId } from "@/lib/officerAnchors";

export const metadata = createPageMetadata({
  path: "/about",
  title: "About",
  description: "Learn about SLHS TSA at Seven Lakes High School, our competition achievements, and how members advance from Regionals to Nationals.",
});
