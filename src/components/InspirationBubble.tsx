...
/**
 * precomputed spark positions avoid random server/client render differences.
 */
...
/**
 * hover and keyboard focus reveal the note; click also triggers the burst effect.
 */
