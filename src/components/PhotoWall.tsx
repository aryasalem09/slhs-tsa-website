...
/**
 * a masonry wall with a keyboard-friendly lightbox.
 */
export default function PhotoWall({ photos }: { photos: GalleryPhoto[] }) {
  ...
  useEffect(() => {
    ...
    function onKey(e: KeyboardEvent) {
      if (!isTop()) return; // another overlay is above this one
      ...
      {current &&
        ...
        >
          ...
          <figure
            ...
            onTouchStart={(e) => {
              // a second finger indicates pinch-zoom, not a swipe
          ...
          >
            ...
            {/* easter egg mechanics: themed stickers pop out around the photo. */}
